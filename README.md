...
The aim for the game is to guess a random word by one letter at the time. You have a limited number of attempts. If you manage to guess the word before you run out of attempts you win, otherwise you get hanged and lose the game.

This is a simple game, but it is challenging. A nice way to relax and challenge yourself.
...
- Files containing HTML, CSS and JavaScript were all provided by [Code Institute](https://codeinstitute.net/) for this project. 
...
In this case I can't take the results to seriously because the HTML, CSS and JavaScript were pre made in the template provided by Code Institute.
